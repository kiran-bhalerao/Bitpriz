...
function (_Component) {
  ...
  function index() {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleClick", function (e, code) {
      console.log(code);
    });
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "renderCountry", function (each) {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("li", {
        className: "items",
        key: each.currency,
        onClick: _this.handleClick.bind(_assertThisInitialized(_assertThisInitialized(_this)), each.currency),
        __source: {
...
//# sourceMappingURL=index.js.a12621edacce217838d8.hot-update.js.map